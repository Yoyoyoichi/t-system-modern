...
<body>
  <a id="sample020" href="sample020.php">
      <font size="5" color="#FF0000">学習画面</font>
  </a>

  <a ID = "testJSCharts2" href="testJSCharts2.php">
      <font size="5" color="#FF0000">カテゴリー3</font>
  </a>

  <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.2.1/Chart.js"></script>

  <p>
  <canvas id="myChart4"style="">お使いのブラウザはcanvasに対応していません。</canvas>
  <br>
  <br>
  <br>
  ...
  <script>
    ...
    document.getElementById("testJSCharts2").href += "?"+DatabaseName;
    document.getElementById("sample020").href += "?"+DatabaseName;
    ...
    if(xmlhttp!=null)
    {
      ...
      console.log("0-1 " + (endTime - startTime) + "ms");
      startTime = new Date();
      xmlhttp.open("POST", "../getChartDataCategory2.php", false);//正解ボタンを押す
      var endTime = new Date();    
      //startTime から endTime までの処理時間をミリ秒で出力。
      console.log("0-2 " + (endTime - startTime) + "ms");
      startTime = new Date();
      ...
      var endTime = new Date();    
      //startTime から endTime までの処理時間をミリ秒で出力。
      console.log("0-3 " + (endTime - startTime) + "ms");
      startTime = new Date();
    ...
    //startTime から endTime までの処理時間をミリ秒で出力。
    console.log("1 " + (endTime - startTime) + "ms");
    ...
    //startTime から endTime までの処理時間をミリ秒で出力。
    console.log("2 " + (endTime - startTime) + "ms");
    ...
    //startTime から endTime までの処理時間をミリ秒で出力。
    console.log("3 "+ (endTime - startTime) + "ms");
    ...
    //startTime から endTime までの処理時間をミリ秒で出力。
    console.log("4 "+ (endTime - startTime) + "ms");
    ...
    //startTime から endTime までの処理時間をミリ秒で出力。
    console.log("5 "+ (endTime - startTime) + "ms");
    ...
    //startTime から endTime までの処理時間をミリ秒で出力。
    console.log("6 "+ (endTime - startTime) + "ms");
    ...
    //startTime から endTime までの処理時間をミリ秒で出力。
    console.log("7 "+ (endTime - startTime) + "ms");
    ...
    endTime = new Date();    
    //startTime から endTime までの処理時間をミリ秒で出力。
    console.log("7-1 "+ (endTime - startTime) + "ms");
    startTime = new Date();
    ...
    endTime = new Date();    
    //startTime から endTime までの処理時間をミリ秒で出力。
    console.log("7-2 "+ (endTime - startTime) + "ms");
    startTime = new Date();
    ...
    endTime = new Date();    
    //startTime から endTime までの処理時間をミリ秒で出力。
    console.log("7-3 "+ (endTime - startTime) + "ms");
    startTime = new Date();
    ...
    endTime = new Date();    
    //startTime から endTime までの処理時間をミリ秒で出力。
    console.log("7-4 "+ (endTime - startTime) + "ms");
    startTime = new Date();
    ...
    endTime = new Date();    
    //startTime から endTime までの処理時間をミリ秒で出力。
    console.log("7-5 "+ (endTime - startTime) + "ms");
    startTime = new Date();
    ...
    //startTime から endTime までの処理時間をミリ秒で出力。
    console.log("8 "+ (endTime - startTime) + "ms");
    ...
    //startTime から endTime までの処理時間をミリ秒で出力。
    console.log("9 "+ (endTime - startTime) + "ms");
    ...
    //startTime から endTime までの処理時間をミリ秒で出力。
    console.log("10 "+ (endTime - startTime) + "ms");
    ...
    //startTime から endTime までの処理時間をミリ秒で出力。
    console.log("11 "+ (endTime - startTime) + "ms");
    ...
    for (let i = 0; i < 181; i++) {
      yesterdays[i] = new Date(now.getFullYear(), now.getMonth(), now.getDate() - 180 + i);
    ...
    //startTime から endTime までの処理時間をミリ秒で出力。
    console.log("12 "+ (endTime - startTime) + "ms");
    ...
    //startTime から endTime までの処理時間をミリ秒で出力。
    console.log("13 "+ (endTime - startTime) + "ms");
    ...
    //startTime から endTime までの処理時間をミリ秒で出力。
    console.log("14 "+ (endTime - startTime) + "ms");
