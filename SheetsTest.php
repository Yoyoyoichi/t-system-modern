...
//    var_dump($response);
    ...
    $sampleSelectBox = "<select name=\"category1\" id='ctg1'onChange='listChange(this);listChanged()' multiple style='width:19%;height:20vh; font-size: 25px;margin:1px'>\n";
    for ( $i = 1; $i < $row_cnt; $i++ ) {
    ...
    $sampleSelectBox = "<select name=\"category2\" id='ctg2' onChange='listChange(this);listChanged()' multiple style='width:19%;height:20vh; font-size: 25px;margin:1px'>\n";
    ...
    $sampleSelectBox = "<select name=\"category3\" id='ctg3' onChange='listChange(this);listChanged()' multiple style='width:19%;height:20vh; font-size: 25px;margin:1px'>\n";
    ...
    $sampleSelectBox = "<select name=\"categoryFour\" id='ctg4' onChange='listChange(this);listChanged()' multiple style='width:19%;height:20vh; font-size: 25px;margin:1px'>\n";
    ...
    $sampleSelectBox = "<select name=\"categoryFive\" id='ctg5' onChange='listChange(this);listChanged()' multiple style='width:19%;height:20vh; font-size: 25px;margin:1px'>\n";
...
<br>
<input type="button" id="showButton" value="陦ｨ遉ｺ" onclick='sendRequest()' style='font-size: 20px;width: 20%; height: 30px'>
<br>
<div id="spreadsheet" style="height: 700px;"></div>
...
縲縲縲givenData[i-1] = [];
  ...
  var changed = function(instance, cell, x, y, value) {
    ...
    var moji="update" + "^^^^^" +  db_name + "^^^^^" + columnName + "^^^^^" + value + "^^^^^" +  Number(questionNumber)  ;
  ...
  var insertrow = function(instance, rowNumber){
  ...
  var deleterow = function(instance, rowNumber){
  ...
  var table1 = jexcel(document.getElementById('spreadsheet'), {
      ...
      columns:[
          ...
          { title:'question', width:300, wordWrap:true},        
          { title:'category1', width:50},
          { title:'category2', width:50},
          { title:'category3', width:50},
          { title:'category4', width:50},
          { title:'category5', width:50},
