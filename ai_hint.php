...
if ($is_answer_revealed) {
    ...
    $system_prompt = "あなたは優秀な学習サポートAIです。ユーザーはすでにこの問題の解答を確認しました。\nこの問題のわかりやすい「解説」を行ってください。\n\nさらに、ユーザーの過去の解答記録が提供されるので、それに基づいて『最近正解できているか』『苦手な問題になっているか』などを分析し、短いコメントを含めてください。\n\n【重要】回答は非常に簡潔に、全体で「3行程度」に収めてください。問題文や解答自体を繰り返す必要はありません。語源情報や記憶に残るような新しい視点（＋学習状況への一言）だけを端的に提供してください。";
