...
async function sendRequest(){
    ...
    if (questionnumbers && questionnumbers.length === 0 && flag1 == true) {
      ...
      if (MaxQuestionNumber <= (questionnumbers ? questionnumbers.length : 0)) {
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    metadataLayout.style.cssText = 'display: flex; gap: 16px; width: 100%; align-items: stretch; margin-bottom: 16px; min-height: 140px;';
    ...
    const aiHintWrapper = document.createElement('div');
    aiHintWrapper.style.cssText = 'flex: 1; min-width: 0; position: relative;';
    
    const aiHintBox = document.createElement('div');
    aiHintBox.id = 'msc-ai-hint-box';
    aiHintBox.style.cssText = 'display: none; position: absolute; top: 0; left: 0; right: 0; bottom: 0; padding: 16px; background: #f8fafc; border: 2px solid #bbf7d0; border-radius: 8px; font-size: 16px; color: #334155; line-height: 1.6; white-space: pre-wrap; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1); overflow-y: auto;';
