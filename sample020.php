...
require_once 'db_wrapper.php';
 ...
 <div id ="grandParent1">
    ...
    <a id="resultgraph" href="testJSCharts.php">
        <font size="4" color="#38a3ea">結果グラチE/font>
    </a>
    &nbsp;&nbsp;
    ...
    <a id="reminder" href="reminder.php">
        <font size="4" color="#38a3ea">復翁E/font>
    </a>
    &nbsp;&nbsp;
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  if (!empty($_POST["DB_name"])) {
    ...
    echo "<p style='font-size:20px;color:#FF0000;width:60vw;padding : 0px 0px 0px 0px;'> めE��た問題数の合計�E$testo です、Ebr><br>
    今日めE��た合計�E $todayQuestonDone です、Ebr><br>
    正解の合計�E $test2 です、Ebr><br>
    不正解の合計�E $test3 です、E<br><br>
    正答率は $seitoritu �E�E��す、Ebr><br>
    前回は $test4 でした、E<br><br>
...
　<div style="float: left; width:35%;margin:15px 0px 0px 0px">
    ...
    <font size="6" class = 'info02' color="#000000" style=";vertical-align:middle">啁E/font>
  </div>
<!--   <select class="selectBox" name='MaxQuestionNumber' id='MaxQuestionNumber' onchange = "settingSave()"
...
<div id ="setting" class="setting" style=" width:93%" >
  <pre style='font-size: 25px'>設宁E/pre>
  ...
  <font size="4" color="#000000" class="checkText" ;>問顁E解筁E/font>
  ...
  <font size="4" color="#000000" class="checkText";>キー操佁E/font>
  <br>
  ...
  <font size="4" color="#000000" class="checkText";>真っ黁E/font>
  <br>
