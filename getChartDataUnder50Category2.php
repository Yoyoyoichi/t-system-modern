...
for($i = 1; $i < $row_cnt; $i++){
	...
	$str_sql = "select * from $db_name where (correct/(correct + incorrect) * 100 <= 80 and (incorrect > 0  or correct > 0 ) and category2 = '$pieces[$i]') or (correct > 0 and correct < 3 and category2 = '$pieces[$i]')";
	// echo $str_sql.",\n"."\n";//
